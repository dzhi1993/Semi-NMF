...
def test_spectral_clustering(eigen_solver, assign_labels):
    ...
    data = betaValueMatrix['data'].transpose()

    model = SpectralClustering(random_state=0, n_clusters=10,
...
def main():
    ...
    test_spectral_clustering(eigen_solver="lobpcg", assign_labels="kmeans")
